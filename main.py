...
def main():
    ...
    if teste_sincronizacao:
        ...
        evento_google = {
            ...
            'start': {
                'dateTime': (datetime.now().replace(hour=10, minute=0, second=0) + timedelta(days=1)).isoformat(),
                'timeZone': 'America/Recife',
            },
            'end': {
                'dateTime': (datetime.now().replace(hour=11, minute=0, second=0) + timedelta(days=1)).isoformat(),
                'timeZone': 'America/Recife',
            }
        }
        ...
        try:
            ...
            evento_outlook = {
                ...
                'start': {
                    'dateTime': (datetime.now().replace(hour=14, minute=0, second=0) + timedelta(days=1)).isoformat(),
                    'timeZone': 'America/Recife'
                },
                'end': {
                    'dateTime': (datetime.now().replace(hour=15, minute=0, second=0) + timedelta(days=1)).isoformat(),
                    'timeZone': 'America/Recife'
                }
            }
